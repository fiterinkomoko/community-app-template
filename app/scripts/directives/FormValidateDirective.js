            ...
            return {
                ...
                link: function (scope, elm, attr, ctrl) {
                    ...
                    var template = '<span  ng-show="' + scope.formNameAttribute + '.' + scope.inputAttributeName + '.$invalid">' +
                        '<small class="error" ng-show="' + scope.formNameAttribute + '.' + scope.inputAttributeName + '.$error.required && (rc.' + scope.formNameAttribute + '.attempted || ' + scope.formNameAttribute + '.$submitted)">' +
